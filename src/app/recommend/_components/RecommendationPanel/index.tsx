...
export default function RecommendationPanel({
  ...
  return (
    <div className="mt-auto flex h-[50vh] rounded-tl-[20px] rounded-tr-[20px] bg-white px-4 py-5 sm:mt-0 sm:h-screen sm:max-w-[750px] sm:rounded-tl-none sm:rounded-br-[20px] sm:p-10">
